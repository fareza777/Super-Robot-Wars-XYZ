...
const styles = StyleSheet.create({
  ...
  panelWrap: { position: 'absolute', left: 16, right: 16, top: 60, bottom: 14, flexDirection: 'row', gap: 14 },
  ...
  chatBox: { position: 'absolute', left: '34%', right: '4%', bottom: 30, backgroundColor: 'rgba(8,12,26,0.92)', borderWidth: 1.5, borderColor: '#3a4160', borderRadius: 12, padding: 14 },
