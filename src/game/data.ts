...
export const SPIRITS: Record<SpiritId, SpiritDef> = {
  ...
  riposteverse: { id: 'riposteverse', name: 'Riposte Verse', cost: 55, desc: 'Counter hymn — allies within 3 tiles deal +15% counter-attack damage until end of enemy phase' },
  silenceedge: { id: 'silenceedge', name: 'Silence Edge', cost: 45, desc: 'Hush strike — next hit deals +10% damage and silences the target (cannot counter-attack) until end of enemy phase' },
  brandverse: { id: 'brandverse', name: 'Brand Verse', cost: 55, desc: 'Targeting hex — enemies within 3 tiles are marked (+25 hit & +15% damage taken, 2 turns)' },
  suppressverse: { id: 'suppressverse', name: 'Suppress Verse', cost: 55, desc: 'Suppression fire — enemies within 3 tiles suffer -20 hit on their attacks (2 turns)' },
  ...
  muteverse: { id: 'muteverse', name: 'Mute Verse', cost: 55, desc: 'Void-silence — enemies within 3 tiles are silenced (no counter) and their hits degrade to grazes until end of enemy phase' },
  hazeverse: { id: 'hazeverse', name: 'Haze Verse', cost: 55, desc: 'Fog-bank chant — enemies within 3 tiles are sirened (-15 hit for 2 turns)' },
  huntverse: { id: 'huntverse', name: 'Hunt Verse', cost: 55, desc: 'Predator hymn — allies within 3 tiles brand enemies on hit (marked: +25 hit and +15% damage taken, 2 turns) until end of enemy phase' },
  crackedge: { id: 'crackedge', name: 'Crack Edge', cost: 45, desc: 'Rending strike — next hit deals +10% damage and cracks the target frame (break status, 2 turns)' },
  rendverse: { id: 'rendverse', name: 'Rend Verse', cost: 55, desc: 'Sunder hymn — allies within 3 tiles crack enemy frames on hit (break status, 2 turns) until end of enemy phase' },
  stunedge: { id: 'stunedge', name: 'Stun Edge', cost: 45, desc: 'Neural strike — next hit deals +10% damage and stuns the target (cannot act, 2 turns)' },
  oblivionverse: { id: 'oblivionverse', name: 'Oblivion Verse', cost: 55, desc: 'Null-field chant — enemies within 3 tiles have their hits degraded to graze AND lose all weapon-kind resists until end of enemy phase' },
  jinxverse: { id: 'jinxverse', name: 'Jinx Verse', cost: 55, desc: 'Hexed chant — enemies within 3 tiles deal -10% attack damage AND have their hits degraded to graze until end of enemy phase' },
  ...
  siegeverse: { id: 'siegeverse', name: 'Siege Verse', cost: 55, desc: 'Siege chant — enemies within 3 tiles are silenced (no counter) and lose all weapon-kind resists until end of enemy phase' },
  vexverse: { id: 'vexverse', name: 'Vex Verse', cost: 55, desc: 'Crushing chant — enemies within 3 tiles have weakened attacks (-10%) and are tethered (-1 move) until end of enemy phase' },
  ...
  wraithverse: { id: 'wraithverse', name: 'Wraith Verse', cost: 55, desc: 'Reaper chant — enemies within 3 tiles are cursed (+15% damage taken) and festered (cannot be healed) until end of enemy phase' },
  abyssverse: { id: 'abyssverse', name: 'Abyss Verse', cost: 55, desc: 'Abyssal chant — enemies within 3 tiles are cursed (+15% damage taken) and bane-marked (+25 crit taken) until end of enemy phase' },
  blitzverse: { id: 'blitzverse', name: 'Blitz Verse', cost: 60, desc: 'Blitz hymn — allies within 3 tiles act again after a kill (overdrive-armed)' },
  drainedge: { id: 'drainedge', name: 'Drain Edge', cost: 45, desc: 'Siphon strike — next hit deals +10% damage and drains 20 EN from the target' },
  carnageverse: { id: 'carnageverse', name: 'Carnage Verse', cost: 60, desc: 'Carnage hymn — allies within 3 tiles bane-mark enemies on hit (+25 crit taken) until end of enemy phase' },
  bulwarkedge: { id: 'bulwarkedge', name: 'Bulwark Edge', cost: 45, desc: 'Aegis strike — next hit deals +10% damage and grants self a 500-point i-field until end of enemy phase' },
