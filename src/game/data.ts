...
export const PILOTS = {
  ...
  gara: P({ name: 'Gara Dune', callsign: 'Y-1', melee: 78, ranged: 60, defense: 74, evade: 58, maxSp: 50, spirits: ['grit', 'valor', 'guard', 'vigor', 'sunder'], faceColor: '#ff9d9d', trait: 'siege_breaker' }),
