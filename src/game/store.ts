...
export const useGame = create<Store>((set, get) => ({
  ...
  startSim: () => {
    ...
    set({ phase: 'player', sideId: null, missionCh: { ...ch, seizePos: map.beaconPos, reachPos: map.reachPos }, map, units, crates: map.crates ?? [], kills: 0, salvageCr: 0, missionLoot: [], turn: 1, bossWarned: false, savedBattle: s.savedBattle, simWave: 1, simSettled: false, log: ['▲ VR SIMULATION — WAVE 1', `Objective: ${ch.objective}`, 'Waves escalate. The run ends when the squad falls.'], inspectUid: null, tileInfo: null, dangerZone: false, dangerTiles: new Set(), threatTiles: new Set(), hazardWarn: [], blizzard: false, midDialog: null, eventsFired: [], notice: '▲ VR SIMULATION — WAVE 1', usedSupport: false, altKill: false, decoyHit: false, iFieldKill: false, arcKill: false, blastKill: false, lostAlly: false, rescuedPods: [], snipeKill: false, bossRush: false, usedResupply: false });
  ...
  allocPP: (defId, statId) => {
    ...
    const skills = { hit: 0, evade: 0, dmg: 0, def: 0, countercut: 0, esave: 0, hitrun: 0, crit: 0, scavenger: 0, regen: 0, riposte: 0, lastStand: 0, assassin: 0, brawler: 0, initiative: 0, gunner: 0, plunderer: 0, bodyguard: 0, opportunist: 0, warcry: 0, pointBlank: 0, bloodlust: 0, reaver: 0, bulwark: 0, duelist: 0, juggernaut: 0, giantSlayer: 0, loneWolf: 0, overwhelm: 0, outgunned: 0, tankbuster: 0, coordinator: 0, sentinel: 0, gambit: 0, warcaster: 0, underdog: 0, skirmisher: 0, engineer: 0, cohort: 0, entrench: 0, steadfast: 0, precision: 0, surge: 0, reflex: 0, outflank: 0, foeswarm: 0, cannonade: 0, gunsmith: 0, luminance: 0, swarmer: 0, phantomstep: 0, parry: 0, piercer: 0, heavycal: 0, anchor: 0, dreadnought: 0, resolute: 0, siegeadept: 0, cadence: 0, wingman: 0, fullmag: 0, dirgesong: 0, burnout: 0, divebomb: 0, arsenalmind: 0, titanbreaker: 0, truesight: 0, backliner: 0, bombard: 0, ruinbreaker: 0, artillerist: 0, paintburst: 0, fortsoul: 0, hexsurge: 0, coldsteel: 0, capacitor: 0, ironbound: 0, coolloop: 0, gritguard: 0, savant: 0, shieldpierce: 0, pureshot: 0, finisher: 0, aerobat: 0, sureshot: 0, wildfire: 0, archer: 0, stormeye: 0, acehunter: 0, ravager: 0, sledge: 0, overkill: 0, pike: 0, wildswing: 0, zenith: 0, closecombat: 0, chainblade: 0, exploiter: 0, viper: 0, disruptor: 0, myrmidon: 0, sunderfist: 0, bloodborne: 0, harvester: 0, gridshock: 0, shockjock: 0, biggame: 0, razor: 0, retribution: 0, bloodhound: 0, headhunter: 0, soulcut: 0, wardancer: 0, butcher: 0, punisher: 0, wrathborn: 0, tracker: 0, carver: 0, highvolt: 0, ironwill: 0, vigilant: 0, bloodfrenzy: 0, spectral: 0, hexblade: 0, graceful: 0, flakmaster: 0, shepherd: 0, madmen: 0, predator: 0, wither: 0, grandstand: 0, vanguard: 0, phalanx: 0, polymath: 0, isolator: 0, scourge: 0, bloodtrance: 0, snipersoul: 0, aegisshield: 0, stunlock: 0, polluter: 0, finale: 0, sunderborn: 0, landslide: 0, sapper: 0, flanker: 0, tormentor: 0, godsbreaker: 0, momentum: 0, vitals: 0, highhand: 0, saboteur: 0, barrierbane: 0, huntsman: 0, guardbreaker: 0, opening: 0, remembrance: 0, scrapper: 0, ballisteur: 0, awestruck: 0, lifeline: 0, lowburn: 0, bigbang: 0, irongroove: 0, ashstalker: 0, dominant: 0, crossfire: 0, reaping: 0, luminarch: 0, breakdancer: 0, hailborn: 0, rifleborn: 0, flankshot: 0, warlust: 0, halfload: 0, longbarrel: 0, corrosivist: 0, thinner: 0, purist: 0, entropist: 0, suffocator: 0, seaborn: 0, perforator: 0, usurper: 0, empowered: 0, overlord: 0, volleyborn: 0, zenborn: 0, flakborn: 0, highlander: 0, urbanist: 0, preyborn: 0, freefire: 0, tetherborn: 0, shroudborn: 0, curseborn: 0, nullborn: 0, dreadborn: 0, weakborn: 0, dischordborn: 0, powerborn: 0, winterborn: 0, trophyborn: 0, swiftborn: 0, massborn: 0, scorchborn: 0, hyenaborn: 0, davidborn: 0, hushborn: 0, voltborn: 0, garotteborn: 0, matadorborn: 0, ironsideborn: 0, gloomborn: 0, skyborne: 0, rustborn: 0, rootborn: 0, primeborn: 0, spiritborn: 0, sieveborn: 0, wallborn: 0, stifleborn: 0, poxborn: 0, plagueborn: 0, anchorborn: 0, doomborn: 0, frailborn: 0, rotborn: 0, sirenborn: 0, veilborn: 0, beamfoe: 0, gunfoe: 0, missilefoe: 0, meleefoe: 0, funnelfoe: 0, forestborn: 0, desertborn: 0, snowborn: 0, ruinborn: 0, voidborn: 0, willborn: 0, baseborn: 0, roadborn: 0, sniperfoe: 0, moonborn: 0, clusterborn: 0, knockfoe: 0, drainfoe: 0, piercefoe: 0, chainfoe: 0, breakerfoe: 0, volleyfoe: 0, acefoe: 0, hexfoe: 0, wingfoe: 0, skirmfoe: 0, willfoe: 0, mapfoe: 0, voltfoe: 0, shellfoe: 0, truefoe: 0, heavyfoe: 0, critfoe: 0, cannonfoe: 0, skyfoe: 0, regifoe: 0, ambushborn: 0, underborn: 0, breakborn: 0, stunborn: 0, suppborn: 0, markborn: 0, loneborn: 0, eliteborn: 0, dryborn: 0, fuelborn: 0, meekborn: 0, huskborn: 0, rimborn: 0, farborn: 0, spentborn: 0, festerborn: 0, trampleborn: 0, coreborn: 0, rallyborn: 0, cullborn: 0, vengeborn: 0, lavaborn: 0, medicfoe: 0, packborn: 0, gauntletborn: 0, tollborn: 0, ...(prog.skills ?? {}) };
  ...
  useItem: (uid, itemId) => {
    ...
    if (item.apply === 'smoke') {
      const inventory = { ...s.inventory, [itemId]: (s.inventory[itemId] ?? 0) - 1 };
      set({ units: s.units.map((x) => (x.uid === uid ? { ...x, moved: true, acted: true, vanishUntilEndOfEnemyPhase: true } : x)), inventory, usedSupport: true, menuForUid: null, log: push(s.log, `${u.def.name} deploys SMOKE SCREEN — drops off enemy targeting`) });
  ...
  repairUnit: (uid, targetUid) => {
    ...
    const heal = Math.round(t.def.maxHp * 0.4 * (u.def.pilot.trait === 'field_medic' ? 1.5 : 1) * (1 + (u.skills?.engineer ?? 0) * 0.1));
    const enGain = 30;
    const units = s.units.map((x) => {
      if (x.uid === targetUid) {
  ...
  captureUnit: (uid, targetUid) => {
    ...
    const salvage = Math.round((60 * t.level + (t.elite ? 200 : 0)) * (1 + 0.15 * (u.skills?.plunderer ?? 0)) * (u.vaultUntilEndOfEnemyPhase ? 1.5 : 1));
    const units = s.units.map((x) => {
    ...
    set({
      ...
      inventory,
      salvageQueue,
      missionLoot: drop ? [...s.missionLoot, ITEMS[drop].name] : s.missionLoot,
  ...
  chooseTarget: (uid) => {
    ...
    if (s.pendingWeapon.all) {
      ...
      if (result.destroyed && !attAfter.acted) log = push(log, `👻 PHANTOM EDGE — ${att.def.name} may act again`);
  ...
  mineDropUid: null,
    ...
    const carnageArmed = !!att.carnageNext;
    const goreArmed = !!att.goreNext;
    const plunderArmed = !!att.plunderNext;
    ...
    // carnage — the strike's shockwave bleeds into enemies adjacent to the target
    let carnageN = 0;
    {
      const attClone = state.units.find((u) => u.uid === att.uid);
      if (attClone) attClone.carnageNext = false;
      if (attClone) attClone.plunderNext = false;
      if (attClone) attClone.knockNext = false;
      if (attClone) { attClone.lacerateNext = false; attClone.hellfireNext = false; attClone.thrillNext = false; attClone.sunderstormNext = false; attClone.ravenousNext = false; attClone.quakeedgeNext = false; attClone.rageverseNext = false; attClone.heavensverseNext = false; attClone.furyverseNext = false; attClone.levinedgeNext = false; attClone.ravageNext = false; attClone.ghostNext = false; attClone.savageNext = false; attClone.truthedgeNext = false; attClone.novaNext = false; attClone.cullNext = false; attClone.mortalNext = false; attClone.rendNext = false; attClone.snareNext = false; attClone.overNext = false; attClone.arcNext = false; attClone.splatterNext = false; attClone.doomNext = false; attClone.flareNext = false; attClone.maimNext = false; attClone.breachNext = false; attClone.hollowNext = false; attClone.cinderNext = false; attClone.maraudNext = false; attClone.howlNext = false; attClone.vampNext = false; attClone.disarmNext = false; attClone.twinNext = false; attClone.pierceNext = false; attClone.reshiftNext = false; attClone.muteNext = false; attClone.dragNext = false; attClone.blinkNext = false; attClone.curseNext = false; attClone.shroudNext = false; attClone.rustNext = false; attClone.blindNext = false; attClone.crushNext = false; attClone.gloomedgeNext = false; attClone.matadorNext = false; attClone.sieveNext = false; attClone.stifleedgeNext = false; attClone.poxedgeNext = false; attClone.frailedgeNext = false; attClone.rootedgeNext = false; attClone.tangleedgeNext = false; attClone.glitchedgeNext = false; attClone.sealedgeNext = false; attClone.shrededgeNext = false; attClone.surtaxedgeNext = false; attClone.fearedgeNext = false; attClone.baneedgeNext = false; attClone.feebleedgeNext = false; attClone.silenceedgeNext = false; attClone.sirenedgeNext = false; attClone.brandedgeNext = false; attClone.crackedgeNext = false; attClone.stunedgeNext = false; attClone.tetheredgeNext = false; attClone.chokeedgeNext = false; attClone.huskedgeNext = false; attClone.festeredgeNext = false; attClone.drainedgeNext = false; attClone.bulwarkedgeNext = false; }
      if (attClone) attClone.goreNext = false;
      if (attClone && goreArmed && result.hit) {
        attClone.hp = Math.min(attClone.def.maxHp, attClone.hp + Math.round(result.damage * 0.25));
      }
      if (carnageArmed && result.hit) {
        const defNow = state.units.find((u) => u.uid === uid)!;
        for (const e2 of state.units) {
          if (e2.alive && e2.side === 'enemy' && e2.uid !== uid && dist(e2.pos, defNow.pos) <= 1) {
            const sd = Math.round(result.damage * 0.3);
    ...
    if (carnageN > 0) log = push(log, `\u2604 CARNAGE — shockwave tears into ${carnageN} adjacent frame${carnageN === 1 ? '' : 's'}`);
    const plunderCr = plunderArmed && result.hit ? Math.round(result.damage * 0.08) : 0;
    if (plunderCr > 0) log = push(log, `⚓ PLUNDER EDGE — +${plunderCr}cr stripped from the wreck`);
    ...
    const common = {
      ...
      chainTurn: killCount > 0 ? s.turn : s.chainTurn,
      chainCount: chain,
      salvageCr: s.salvageCr + chainBonus + carrierCr + overkillCr + lucky.cr + plunderCr,
      pendingWeapon: null,
      mapAim: null,
  mineDropUid: null,
      attackTiles: new Set<string>(),
  ...
  castSpirit: (uid, sp) => {
    ...
    if (!target || target.sp < spiritCost(target, sp)) {
    ...
    if (sp === 'relay' && !s.units.some((u) => u.alive && u.uid !== uid && u.side === target.side && dist(u.pos, target.pos) <= 3 && u.en < u.def.maxEn)) {
      set({ spiritForUid: null, log: push(s.log, 'Relay: no drained ally within 3 tiles') });
      return;
    }
    ...
    if (sp === 'empower' && !s.units.some((u) => u.alive && u.uid !== uid && u.side === 'player' && dist(u.pos, target.pos) <= 3)) {
      set({ spiritForUid: null, log: push(s.log, 'Empower: no ally within 3 tiles') });
      return;
    }
    if (sp === 'ward' && !s.units.some((u) => u.alive && u.uid !== uid && u.side === 'player' && dist(u.pos, target.pos) <= 3)) {
      set({ spiritForUid: null, log: push(s.log, 'Ward: no ally within 3 tiles') });
      return;
    }
    ...
    // inspire — every ally gains +8 Will
    let inspireLog: string | null = null;
    if (sp === 'inspire') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const u2 of units) {
        if (u2.alive && u2.uid !== uid && u2.side === src.side) {
          u2.will = Math.min(150, u2.will + 8);
          n++;
        }
      }
      inspireLog = `Inspire — ${n} allied frame${n === 1 ? '' : 's'} surge: +8 Will`;
    }
    // veil — sensor mist shrouds nearby allies (+20 evade until end of enemy phase)
    let veilLog: string | null = null;
    if (sp === 'veil') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const u2 of units) {
        if (u2.alive && u2.uid !== uid && u2.side === src.side && dist(u2.pos, src.pos) <= 3) {
          u2.veilUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      veilLog = `Veil — ${n} allied frame${n === 1 ? '' : 's'} cloaked: +20 evade`;
    }
    // cantata — chorus restores +10 SP to allies within 3 tiles
    let cantataLog: string | null = null;
    if (sp === 'cantata') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const u2 of units) {
        if (u2.alive && u2.uid !== uid && u2.side === src.side && dist(u2.pos, src.pos) <= 3 && u2.sp < u2.def.pilot.maxSp) {
          u2.sp = Math.min(u2.def.pilot.maxSp, u2.sp + 10);
          n++;
        }
      }
      cantataLog = `Cantata — ${n} pilot${n === 1 ? '' : 's'} reinvigorated: +10 SP`;
    }
    // warhorn — allies within 3 tiles gain +10% counter damage until end of enemy phase
    let warhornLog: string | null = null;
    if (sp === 'warhorn') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const u2 of units) {
        if (u2.alive && u2.uid !== uid && u2.side === src.side && dist(u2.pos, src.pos) <= 3) {
          u2.counterBuffUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      warhornLog = `Warhorn — ${n} frame${n === 1 ? '' : 's'} ready to punish counters: +10% counter damage`;
    }
    // interfere — enemies within 3 tiles lose the ability to counter until their next phase ends
    let interfereLog: string | null = null;
    if (sp === 'interfere') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.counterSealUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      interfereLog = `Interference — ${n} hostile${n === 1 ? '' : 's'} cannot counter-attack`;
    }
    // safeguard — allies within 3 tiles take -10% damage until end of enemy phase
    let safeguardLog: string | null = null;
    if (sp === 'safeguard') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const u2 of units) {
        if (u2.alive && u2.uid !== uid && u2.side === src.side && dist(u2.pos, src.pos) <= 3) {
          u2.guardAuraUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      safeguardLog = `Safeguard — ${n} frame${n === 1 ? '' : 's'} shielded: -10% damage taken`;
    }
    // suppress — enemies within 3 tiles deal -10% damage until end of enemy phase
    let dischordLog: string | null = null;
    if (sp === 'dischord') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.dischordUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      dischordLog = `Dischord — ${n} hostile${n === 1 ? '' : 's'} disoriented: -15 evade`;
    }
    let absolveLog: string | null = null;
    if (sp === 'absolution') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.statuses = [];
          e.absolveUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      absolveLog = `Absolution — ${n} all${n === 1 ? 'y' : 'ies'} cleansed and steadied: +15 hit`;
    }
    let bannerLog: string | null = null;
    if (sp === 'banner') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.bannerUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      bannerLog = `Banner raised — ${n} all${n === 1 ? 'y' : 'ies'} rallied: +10 hit, +20% counter`;
    }
    let armorrotLog: string | null = null;
    if (sp === 'armorrot') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      armorrotLog = `Armor Rot — ${n} hostile${n === 1 ? '' : 's'} sundered for good`;
    }
    let winterverseLog: string | null = null;
    if (sp === 'winterverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      winterverseLog = `Winter Verse — ${n} hostile${n === 1 ? '' : 's'} slowed`;
    }
    let litanyLog: string | null = null;
    if (sp === 'litany') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.hp = Math.min(e.def.maxHp, e.hp + Math.round(e.def.maxHp * 0.15));
          e.statuses = [];
          n++;
        }
      }
      litanyLog = `Litany — ${n} all${n === 1 ? 'y' : 'ies'} mended and cleansed`;
    }
    let lockcascadeLog: string | null = null;
    if (sp === 'lockcascade') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 4) {
          e.exposed = true;
          n++;
        }
      }
      lockcascadeLog = `Lock Cascade — ${n} hostile${n === 1 ? '' : 's'} painted`;
    }
    let wardmistLog: string | null = null;
    if (sp === 'wardmist') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.statusproofUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      wardmistLog = `Ward Mist — ${n} all${n === 1 ? 'y' : 'ies'} shielded from status`;
    }
    let aegisLog: string | null = null;
    if (sp === 'aegis') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.aegisUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      aegisLog = `Aegis Hymn — ${n} all${n === 1 ? 'y' : 'ies'} proof against criticals`;
    }
    let firelinkLog: string | null = null;
    if (sp === 'firelink') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.firelinkUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      firelinkLog = `Firelink — ${n} all${n === 1 ? 'y' : 'ies'} gain +1 range`;
    }
    let dreadverseLog: string | null = null;
    if (sp === 'dreadverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.will = Math.max(0, e.will - 15);
          e.dreadedUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      dreadverseLog = `Dread Verse — ${n} hostiles lose 15 Will`;
    }
    let sanctumLog: string | null = null;
    if (sp === 'sanctumhymn') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.sanctumUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      sanctumLog = `Sanctum Hymn — ${n} all${n === 1 ? 'y' : 'ies'} gain +400 armor`;
    }
    let staticchoirLog: string | null = null;
    if (sp === 'staticchoir') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 4 && !e.statusproofUntilEndOfEnemyPhase && partBonus(e, 'statusProof') === 0) {
          applyStatus(e, 'supp');
          n++;
        }
      }
      staticchoirLog = `Static Choir — ${n} hostiles suppressed`;
    }
    let dirgemistLog: string | null = null;
    if (sp === 'dirgemist') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.dirgeHealUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      dirgemistLog = `Dirge Mist — ${n} all${n === 1 ? 'y' : 'ies'} gain kill-heal`;
    }
    let chorusLog: string | null = null;
    if (sp === 'miraclechorus') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.chorusUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      chorusLog = `Miracle Chorus — ${n} all${n === 1 ? 'y' : 'ies'} warded from death`;
    }
    let ariaLog: string | null = null;
    if (sp === 'bulwarkaria') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.anchoredUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      ariaLog = `Bulwark Aria — ${n} all${n === 1 ? 'y' : 'ies'} anchored`;
    }
    let pinverseLog: string | null = null;
    if (sp === 'pinverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.pinverseUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      pinverseLog = `Pin Verse — ${n} all${n === 1 ? 'y' : 'ies'} land slow on hit`;
    }
    let tideverseLog: string | null = null;
    if (sp === 'tideverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.tideUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      tideverseLog = `Tide Verse — ${n} all${n === 1 ? 'y' : 'ies'} +1 move`;
    }
    let graceLog: string | null = null;
    if (sp === 'gracehymn') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      graceLog = `Grace Hymn — ${n} all${n === 1 ? 'y' : 'ies'} blessed with regen`;
    }
    let mirrorwallLog: string | null = null;
    if (sp === 'mirrorwall') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.mirrorwallUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      mirrorwallLog = `Mirror Wall — ${n} all${n === 1 ? 'y' : 'ies'} reflect damage`;
    }
    let breachLog: string | null = null;
    if (sp === 'breachverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.breachAtkUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      breachLog = `Breach Verse — ${n} all${n === 1 ? 'y' : 'ies'} pierce armor`;
    }
    let ebbLog: string | null = null;
    if (sp === 'tideebb') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.ebbUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      ebbLog = `Tide Ebb — ${n} foe${n === 1 ? '' : 's'} lose movement`;
    }
    let renewalLog: string | null = null;
    if (sp === 'renewalverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      renewalLog = `Renewal Verse — ${n} all${n === 1 ? 'y' : 'ies'} regenerate EN`;
    }
    let valiantLog: string | null = null;
    if (sp === 'valiantverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.valiantUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      valiantLog = `Valiant Verse — ${n} all${n === 1 ? 'y' : 'ies'} empowered`;
    }
    let exposeLog: string | null = null;
    if (sp === 'exposeverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      exposeLog = `Expose Verse — ${n} foe${n === 1 ? '' : 's'} revealed`;
    }
    let darkLog: string | null = null;
    if (sp === 'darkverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.en = Math.max(0, e.en - 15);
          n++;
        }
      }
      darkLog = `Dark Verse — ${n} foe${n === 1 ? '' : 's'} lose 15 EN`;
    }
    let foresightLog: string | null = null;
    if (sp === 'foresightverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
      ...
      foresightLog = `Foresight Verse — ${n} all${n === 1 ? 'y' : 'ies'} gain evade`;
    }
    let bastionLog: string | null = null;
    if (sp === 'bastionverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      bastionLog = `Bastion Verse — ${n} all${n === 1 ? 'y' : 'ies'} gain armor`;
    }
    let tracerLog: string | null = null;
    if (sp === 'tracerverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.tracerAllyUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      tracerLog = `Tracer Verse — ${n} all${n === 1 ? 'y' : 'ies'} paint foes`;
    }
    let sirenLog: string | null = null;
    if (sp === 'sirenverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      sirenLog = `Siren Verse — ${n} foe${n === 1 ? '' : 's'} lose aim`;
    }
    let rustLog: string | null = null;
    if (sp === 'rustverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      rustLog = `Rust Verse — ${n} foe${n === 1 ? '' : 's'} corroded`;
    }
    let stifleLog: string | null = null;
    if (sp === 'stifleverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      stifleLog = `Stifle Verse — ${n} foe${n === 1 ? '' : 's'} starved of EN`;
    }
    let scorchLog: string | null = null;
    if (sp === 'scorchverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.scorchUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      scorchLog = `Scorch Verse — ${n} all${n === 1 ? 'y' : 'ies'} igniting`;
    }
    let undyingLog: string | null = null;
    if (sp === 'undyingverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.undyingUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      undyingLog = `Undying Verse — ${n} all${n === 1 ? 'y' : 'ies'} deathless`;
    }
    let jamLog: string | null = null;
    if (sp === 'jamverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          for (const w2 of e.def.weapons) if (w2.ammo != null) e.ammo[w2.id] = Math.max(0, (e.ammo[w2.id] ?? 0) - 2);
          n++;
        }
      }
      jamLog = `Jam Verse — ${n} enem${n === 1 ? 'y' : 'ies'} disarmed`;
    }
    let despairLog: string | null = null;
    if (sp === 'despairverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.will = Math.max(100, e.will - 15);
          n++;
        }
      }
      despairLog = `Despair Verse — ${n} enem${n === 1 ? 'y' : 'ies'} -15 will`;
    }
    let lanceLog: string | null = null;
    if (sp === 'lanceverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.lanceUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      lanceLog = `Lance Verse — ${n} all${n === 1 ? 'y' : 'ies'} pierce armor`;
    }
    let wardenLog: string | null = null;
    if (sp === 'wardenverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.terraUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      wardenLog = `Warden Verse — ${n} all${n === 1 ? 'y' : 'ies'} warded`;
    }
    let rotLog: string | null = null;
    if (sp === 'rotverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      rotLog = `Rot Verse — ${n} enem${n === 1 ? 'y' : 'ies'} necrotized`;
    }
    let frailLog: string | null = null;
    if (sp === 'frailverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      frailLog = `Frail Verse — ${n} enem${n === 1 ? 'y' : 'ies'} made frail`;
    }
    let surgeLog: string | null = null;
    if (sp === 'surgeverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.surgeUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      surgeLog = `Surge Verse — ${n} all${n === 1 ? 'y' : 'ies'} crit surging`;
    }
    let damperLog: string | null = null;
    if (sp === 'damperverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.damperUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      damperLog = `Damper Verse — ${n} all${n === 1 ? 'y' : 'ies'} capped at 3000`;
    }
    let gloomLog: string | null = null;
    if (sp === 'gloomverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      gloomLog = `Gloom Verse — ${n} enem${n === 1 ? 'y' : 'ies'} blinded`;
    }
    let tangleLog: string | null = null;
    if (sp === 'tangleverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.tangleUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      tangleLog = `Tangle Verse — ${n} enem${n === 1 ? 'y' : 'ies'} tangled`;
    }
    let leechvLog: string | null = null;
    if (sp === 'leechverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.leechUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      leechvLog = `Leech Verse — ${n} all${n === 1 ? 'y' : 'ies'} bloodletting`;
    }
    let thornLog: string | null = null;
    if (sp === 'thornverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.thornUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      thornLog = `Thorn Verse — ${n} all${n === 1 ? 'y' : 'ies'} bristling`;
    }
    let surtaxLog: string | null = null;
    if (sp === 'surtaxverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.surtaxUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      surtaxLog = `Surtax Verse — ${n} enem${n === 1 ? 'y' : 'ies'} levied`;
    }
    let huskLog: string | null = null;
    if (sp === 'huskverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.huskUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      huskLog = `Husk Verse — ${n} enem${n === 1 ? 'y' : 'ies'} husked`;
    }
    let vaultLog: string | null = null;
    if (sp === 'vaultverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.vaultUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      vaultLog = `Vault Verse — ${n} all${n === 1 ? 'y' : 'ies'} prospecting`;
    }
    let freeflowLog: string | null = null;
    if (sp === 'freeflowverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.freeflowUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      freeflowLog = `Freeflow Verse — ${n} all${n === 1 ? 'y' : 'ies'} unshackled`;
    }
    let feebleLog: string | null = null;
    if (sp === 'feebleverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.feebleUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      feebleLog = `Feeble Verse — ${n} enem${n === 1 ? 'y' : 'ies'} enfeebled`;
    }
    let festerLog: string | null = null;
    if (sp === 'festerverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.festerUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      festerLog = `Fester Verse — ${n} enem${n === 1 ? 'y' : 'ies'} festering`;
    }
    let slayLog: string | null = null;
    if (sp === 'slayverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.slayUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      slayLog = `Slay Verse — ${n} all${n === 1 ? 'y' : 'ies'} sharpened`;
    }
    let flakLog: string | null = null;
    if (sp === 'flakverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.flakUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      flakLog = `Flak Verse — ${n} all${n === 1 ? 'y' : 'ies'} screened`;
    }
    let chokeLog: string | null = null;
    if (sp === 'chokerverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.chokeUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      chokeLog = `Choker Verse — ${n} enem${n === 1 ? 'y' : 'ies'} choked`;
    }
    let lureLog: string | null = null;
    if (sp === 'lureverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.provokedTo = src.uid;
          n++;
        }
      }
      lureLog = `Lure Verse — ${n} enem${n === 1 ? 'y' : 'ies'} baited`;
    }
    let fableLog: string | null = null;
    if (sp === 'fableverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.fableUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      fableLog = `Fable Verse — ${n} all${n === 1 ? 'y' : 'ies'} saga-touched`;
    }
    let sustainLog: string | null = null;
    if (sp === 'sustainverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.sustainUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      sustainLog = `Sustain Verse — ${n} all${n === 1 ? 'y' : 'ies'} auto-resupply`;
    }
    let rootLog: string | null = null;
    if (sp === 'rootverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.rootedUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      rootLog = `Root Verse — ${n} hostiles pinned in place`;
    }
    let maimLog: string | null = null;
    if (sp === 'maimverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3 && !e.crippled) {
          e.crippled = true;
          n++;
        }
      }
      maimLog = `Maim Verse — ${n} hostiles crippled`;
    }
    let revelLog: string | null = null;
    if (sp === 'revelverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.revelUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      revelLog = `Revel Verse — ${n} all${n === 1 ? 'y' : 'ies'} spirit-charged`;
    }
    let bulwarkLog: string | null = null;
    if (sp === 'bulwarkverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.bulwarkUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      bulwarkLog = `Bulwark Verse — ${n} all${n === 1 ? 'y' : 'ies'} melee-warded`;
    }
    let poxLog: string | null = null;
    if (sp === 'poxverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      poxLog = `Pox Verse — ${n} foe${n === 1 ? '' : 's'} corroding`;
    }
    let shatterLog: string | null = null;
    if (sp === 'shatterverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.sieveUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      shatterLog = `Shatter Verse — ${n} barrier${n === 1 ? '' : 's'} collapsed`;
    }
    let anchorLog: string | null = null;
    if (sp === 'anchorverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      anchorLog = `Anchor Verse — ${n} all${n === 1 ? 'y' : 'ies'} anchored`;
    }
    let beamLog: string | null = null;
    if (sp === 'beamverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.beamverseUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      beamLog = `Beam Verse — ${n} all${n === 1 ? 'y' : 'ies'} beam-tuned`;
    }
    let riftLog: string | null = null;
    if (sp === 'riftverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3 && dist(e.pos, src.pos) > 1 && partBonus(e, 'knockProof') === 0 && !e.anchoredUntilEndOfEnemyPhase) {
          const px = Math.sign(src.pos.x - e.pos.x);
          const py = Math.sign(src.pos.y - e.pos.y);
          const opts = Math.abs(e.pos.x - src.pos.x) >= Math.abs(e.pos.y - src.pos.y)
            ? [{ x: e.pos.x + px, y: e.pos.y }, { x: e.pos.x, y: e.pos.y + py }]
            : [{ x: e.pos.x, y: e.pos.y + py }, { x: e.pos.x + px, y: e.pos.y }];
          for (const np of opts) {
            if (np.x < 0 || np.y < 0 || np.x >= s.map.cols || np.y >= s.map.rows) continue;
            if (!TERRAIN_INFO[terrainAt(s.map, np)].passable[e.def.moveType]) continue;
            if (units.some((o) => o.alive && o.pos.x === np.x && o.pos.y === np.y)) continue;
            e.pos = np;
            n++;
            break;
          }
      ...
      riftLog = `Rift Verse — ${n} foe${n === 1 ? '' : 's'} dragged in`;
    }
    let glitchLog: string | null = null;
    if (sp === 'glitchverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.glitchUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      glitchLog = `Glitch Verse — ${n} foe${n === 1 ? '' : 's'} degraded to grazes`;
    }
    let warlordLog: string | null = null;
    if (sp === 'warlordverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.warlordUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      warlordLog = `Warlord Verse — ${n} all${n === 1 ? 'y' : 'ies'} melee-tuned`;
    }
    let shellLog: string | null = null;
    if (sp === 'shellverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.shellUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      shellLog = `Shell Verse — ${n} all${n === 1 ? 'y' : 'ies'} missile-tuned`;
    }
    let gunLog: string | null = null;
    if (sp === 'gunverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.gunUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      gunLog = `Gun Verse — ${n} all${n === 1 ? 'y' : 'ies'} gun-tuned`;
    }
    let funnelLog: string | null = null;
    if (sp === 'funnelverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.funnelUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      funnelLog = `Funnel Verse — ${n} all${n === 1 ? 'y' : 'ies'} funnel-tuned`;
    }
    let sealLog: string | null = null;
    if (sp === 'sealverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.mapSealUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      sealLog = `Seal Verse — ${n} foe${n === 1 ? '' : 's'} MAP-sealed`;
    }
    let zeroLog: string | null = null;
    if (sp === 'zeroverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.resistSealUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      zeroLog = `Zero Verse — ${n} foe${n === 1 ? '' : 's'} resist-stripped`;
    }
    let baneLog: string | null = null;
    if (sp === 'baneverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.baneUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      baneLog = `Bane Verse — ${n} foe${n === 1 ? '' : 's'} bane-marked`;
    }
    let duskLog: string | null = null;
    if (sp === 'duskverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      duskLog = `Dusk Verse — ${n} foe${n === 1 ? '' : 's'} gloomed & sealed`;
    }
    let reactorLog: string | null = null;
    if (sp === 'reactorverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.en = Math.min(e.def.maxEn, e.en + 30);
          n++;
        }
      }
      reactorLog = `Reactor Verse — ${n} allies +30 EN`;
    }
    let haloLog: string | null = null;
    if (sp === 'haloverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.haloUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      haloLog = `Halo Verse — ${n} allies warded`;
    }
    let viceLog: string | null = null;
    if (sp === 'viceverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.silencedUntilEndOfEnemyPhase = true;
          e.tetherUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      viceLog = `Vice Verse — ${n} enem${n === 1 ? 'y' : 'ies'} gripped`;
    }
    let drainLog: string | null = null;
    if (sp === 'drainverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.en = Math.max(0, e.en - 20);
          n++;
        }
      }
      drainLog = `Drain Verse — ${n} enem${n === 1 ? 'y' : 'ies'} sapped`;
    }
    let emberLog: string | null = null;
    if (sp === 'emberverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.emberUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      emberLog = `Ember Verse — ${n} allies ignite`;
    }
    let bombardLog: string | null = null;
    if (sp === 'bombardverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.bombardverseUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      bombardLog = `Bombard Verse — ${n} allies' MAP weapons charged`;
    }
    let cowardLog: string | null = null;
    if (sp === 'cowardverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.will = Math.max(100, e.will - 20);
          n++;
        }
      }
      cowardLog = `Coward Verse — ${n} enem${n === 1 ? 'y' : 'ies'} shaken`;
    }
    let nadirLog: string | null = null;
    if (sp === 'nadirverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      nadirLog = `Nadir Verse — ${n} enem${n === 1 ? 'y' : 'ies'} stripped & sealed`;
    }
    let hasteLog: string | null = null;
    if (sp === 'hasteverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.hasteUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      hasteLog = `Haste Verse — ${n} allies hastened`;
    }
    let riposteLog: string | null = null;
    if (sp === 'riposteverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.riposteUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      riposteLog = `Riposte Verse — ${n} allies counter-charged`;
    }
    let brandLog: string | null = null;
    if (sp === 'brandverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      brandLog = `Brand Verse — ${n} enem${n === 1 ? 'y' : 'ies'} marked`;
    }
    let suppressvLog: string | null = null;
    if (sp === 'suppressverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      suppressvLog = `Suppress Verse — ${n} enem${n === 1 ? 'y' : 'ies'} suppressed`;
    }
    let arsenalLog: string | null = null;
    if (sp === 'arsenalverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          for (const w of e.def.weapons) if (w.ammo != null) e.ammo[w.id] = maxAmmoOf(e, w);
          n++;
        }
      }
      arsenalLog = `Arsenal Verse — ${n} all${n === 1 ? 'y' : 'ies'} ammo restocked`;
    }
    let staticLog: string | null = null;
    if (sp === 'staticverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.suppbrandUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      staticLog = `Static Verse — ${n} all${n === 1 ? 'y' : 'ies'} suppress foes on hit`;
    }
    let siegeLog: string | null = null;
    if (sp === 'siegeverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      siegeLog = `Siege Verse — ${n} enem${n === 1 ? 'y' : 'ies'} silenced & stripped`;
    }
    let vexLog: string | null = null;
    if (sp === 'vexverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.weakenUntilEndOfEnemyPhase = true;
          e.tetherUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      vexLog = `Vex Verse — ${n} enem${n === 1 ? 'y' : 'ies'} weakened & tethered`;
    }
    let pealLog: string | null = null;
    if (sp === 'pealverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.stunbrandUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      pealLog = `Peal Verse — ${n} all${n === 1 ? 'y' : 'ies'} stunning foes on hit`;
    }
    let pierceLog: string | null = null;
    if (sp === 'pierceverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.piercebrandUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      pierceLog = `Pierce Verse — ${n} all${n === 1 ? 'y' : 'ies'} punching through barriers`;
    }
    let wraithLog: string | null = null;
    if (sp === 'wraithverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.cursedUntilEndOfEnemyPhase = true;
          e.festerUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      wraithLog = `Wraith Verse — ${n} enem${n === 1 ? 'y' : 'ies'} cursed & festered`;
    }
    let abyssLog: string | null = null;
    if (sp === 'abyssverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      abyssLog = `Abyss Verse — ${n} enem${n === 1 ? 'y' : 'ies'} cursed & bane-marked`;
    }
    let blitzLog: string | null = null;
    if (sp === 'blitzverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      blitzLog = `Blitz Verse — ${n} all${n === 1 ? 'y' : 'ies'} overdrive-armed`;
    }
    let carnageLog: string | null = null;
    if (sp === 'carnageverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.banebrandUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      carnageLog = `Carnage Verse — ${n} all${n === 1 ? 'y' : 'ies'} bane-marking foes on hit`;
    }
    let snareLog: string | null = null;
    if (sp === 'snareverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      snareLog = `Snare Verse — ${n} enem${n === 1 ? 'y' : 'ies'} tethered & choked`;
    }
    let quietusLog: string | null = null;
    if (sp === 'quietusverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      quietusLog = `Quietus Verse — ${n} enem${n === 1 ? 'y' : 'ies'} silenced & festered`;
    }
    let bountyLog: string | null = null;
    if (sp === 'bountyverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.luckyForNextKill = true;
          n++;
        }
      }
      bountyLog = `Bounty Verse — ${n} all${n === 1 ? 'y' : 'ies'} fortune-armed`;
    }
    let graveLog: string | null = null;
    if (sp === 'graveverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      graveLog = `Grave Verse — ${n} enem${n === 1 ? 'y' : 'ies'} weakened & dischorded`;
    }
    let rimeLog: string | null = null;
    if (sp === 'rimeverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.slowbrandUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      rimeLog = `Rime Verse — ${n} all${n === 1 ? 'y' : 'ies'} chill foes on hit`;
    }
    let jinxLog: string | null = null;
    if (sp === 'jinxverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      jinxLog = `Jinx Verse — ${n} enem${n === 1 ? 'y' : 'ies'} weakened, hits graze only`;
    }
    let oblLog: string | null = null;
    if (sp === 'oblivionverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      oblLog = `Oblivion Verse — ${n} enem${n === 1 ? 'y' : 'ies'} graze only, resists gone`;
    }
    let rendLog: string | null = null;
    if (sp === 'rendverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.breakbrandUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      rendLog = `Rend Verse — ${n} all${n === 1 ? 'y' : 'ies'} crack armor on hit`;
    }
    let huntLog: string | null = null;
    if (sp === 'huntverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.markbrandUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      huntLog = `Hunt Verse — ${n} all${n === 1 ? 'y' : 'ies'} brand enemies on hit`;
    }
    let hazeLog: string | null = null;
    if (sp === 'hazeverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      hazeLog = `Haze Verse — ${n} enem${n === 1 ? 'y' : 'ies'} sirened: -15 hit`;
    }
    let muteLog: string | null = null;
    if (sp === 'muteverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      muteLog = `Mute Verse — ${n} enem${n === 1 ? 'y' : 'ies'} muted: no counters, hits become grazes`;
    }
    let keenLog: string | null = null;
    if (sp === 'keenverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.keenUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      keenLog = `Keen Verse — ${n} allies sharpened`;
    }
    let clarionLog: string | null = null;
    if (sp === 'clarionverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      clarionLog = `Clarion Verse — ${n} all${n === 1 ? 'y' : 'ies'} gain aim`;
    }
    let rampartLog: string | null = null;
    if (sp === 'rampartverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.rampartUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      rampartLog = `Rampart Verse — ${n} all${n === 1 ? 'y' : 'ies'} shielded vs ranged`;
    }
    let curseLog: string | null = null;
    if (sp === 'curseverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      curseLog = `Curse Verse — ${n} foe${n === 1 ? '' : 's'} withered`;
    }
    let vigorLog: string | null = null;
    if (sp === 'vigorverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.will = Math.min(150, (e.will ?? 100) + 10);
          n++;
        }
      }
      vigorLog = `Vigor Verse — ${n} all${n === 1 ? 'y' : 'ies'} gain +10 Will`;
    }
    let phantomLog: string | null = null;
    if (sp === 'phantomverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.phantomUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      phantomLog = `Phantom Verse — ${n} all${n === 1 ? 'y' : 'ies'} attack uncounterable`;
    }
    let crimsonLog: string | null = null;
    if (sp === 'crimsonverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.crimsonUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      crimsonLog = `Crimson Verse — ${n} all${n === 1 ? 'y' : 'ies'} drain 15% hull per kill`;
    }
    let scopeLog: string | null = null;
    if (sp === 'scopeverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.scopeUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      scopeLog = `Scope Verse — ${n} all${n === 1 ? 'y' : 'ies'} +15 hit vs marked`;
    }
    let doomLog: string | null = null;
    if (sp === 'doomverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      doomLog = `Doom Verse — ${n} foe${n === 1 ? '' : 's'} decaying`;
    }
    let flowLog: string | null = null;
    if (sp === 'flowverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.en = Math.min(e.def.maxEn, e.en + 20);
          n++;
        }
      }
      flowLog = `Flow Verse — ${n} all${n === 1 ? 'y' : 'ies'} recover +20 EN`;
    }
    let oathLog: string | null = null;
    if (sp === 'oathverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.oathUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      oathLog = `Oath Verse — ${n} all${n === 1 ? 'y' : 'ies'} gain +600 armor`;
    }
    let goreLog: string | null = null;
    if (sp === 'goreverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.goreUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      goreLog = `Gore Verse — ${n} all${n === 1 ? 'y' : 'ies'} go berserk`;
    }
    let mirageLog: string | null = null;
    if (sp === 'mirageverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.mirageUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      mirageLog = `Mirage Verse — ${n} all${n === 1 ? 'y' : 'ies'} gain +15 evade`;
    }
    let hexLog: string | null = null;
    if (sp === 'hexverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      hexLog = `Hex Verse — ${n} hostile${n === 1 ? '' : 's'} marked + suppressed`;
    }
    let triumphLog: string | null = null;
    if (sp === 'triumphverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.triumphUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      triumphLog = `Triumph Verse — ${n} all${n === 1 ? 'y' : 'ies'} gain +10% damage`;
    }
    let fortressLog: string | null = null;
    if (sp === 'fortressverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.fortressUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      fortressLog = `Fortress Verse — ${n} all${n === 1 ? 'y' : 'ies'} gain melee guard`;
    }
    let bindLog: string | null = null;
    if (sp === 'bindverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      bindLog = `Bind Verse — ${n} hostile${n === 1 ? '' : 's'} slowed + marked`;
    }
    let blightLog: string | null = null;
    if (sp === 'blightverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      blightLog = `Blight Verse — ${n} hostile${n === 1 ? '' : 's'} burn + crack`;
    }
    let vigilLog: string | null = null;
    if (sp === 'vigilverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.vigilUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      vigilLog = `Vigil Verse — ${n} all${n === 1 ? 'y' : 'ies'} counter at +15%`;
    }
    let sentinelLog: string | null = null;
    if (sp === 'sentinelverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.sentinelUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      sentinelLog = `Sentinel Verse — ${n} all${n === 1 ? 'y' : 'ies'} now intercept for adjacent allies`;
    }
    let leechLog: string | null = null;
    if (sp === 'siphonverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.siphonUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      leechLog = `Siphon Verse — ${n} all${n === 1 ? 'y' : 'ies'} drain 10 EN per hit`;
    }
    let terrorLog: string | null = null;
    if (sp === 'terrorverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      terrorLog = `Terror Verse — ${n} enem${n === 1 ? 'y' : 'ies'} stunned and marked`;
    }
    let salvoLog: string | null = null;
    if (sp === 'salvoverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.salvoUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      salvoLog = `Salvo Verse — ${n} all${n === 1 ? 'y' : 'ies'} +15% ranged damage`;
    }
    let shelterLog: string | null = null;
    if (sp === 'shelterverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.shelterUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      shelterLog = `Shelter Verse — ${n} all${n === 1 ? 'y' : 'ies'} shielded from MAP attacks`;
    }
    let cleanseLog: string | null = null;
    if (sp === 'cleanseverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          ...
          e.sirenTurns = 0;
          e.rustTurns = 0;
          e.stifleTurns = 0; e.rotTurns = 0; e.frailTurns = 0; e.gloomTurns = 0; e.poxTurns = 0; e.surgeUntilEndOfEnemyPhase = false; e.damperUntilEndOfEnemyPhase = false; e.tangleUntilEndOfEnemyPhase = false; e.leechUntilEndOfEnemyPhase = false; e.thornUntilEndOfEnemyPhase = false; e.surtaxUntilEndOfEnemyPhase = false; e.huskUntilEndOfEnemyPhase = false; e.vaultUntilEndOfEnemyPhase = false; e.freeflowUntilEndOfEnemyPhase = false; e.feebleUntilEndOfEnemyPhase = false; e.festerUntilEndOfEnemyPhase = false; e.slayUntilEndOfEnemyPhase = false; e.flakUntilEndOfEnemyPhase = false; e.chokeUntilEndOfEnemyPhase = false; e.fableUntilEndOfEnemyPhase = false; e.sustainUntilEndOfEnemyPhase = false; e.rootedUntilEndOfEnemyPhase = false; e.revelUntilEndOfEnemyPhase = false; e.sieveUntilEndOfEnemyPhase = false; e.bulwarkUntilEndOfEnemyPhase = false; e.beamverseUntilEndOfEnemyPhase = false; e.glitchUntilEndOfEnemyPhase = false; e.warlordUntilEndOfEnemyPhase = false; e.shellUntilEndOfEnemyPhase = false; e.mapSealUntilEndOfEnemyPhase = false; e.resistSealUntilEndOfEnemyPhase = false; e.gunUntilEndOfEnemyPhase = false; e.funnelUntilEndOfEnemyPhase = false; e.baneUntilEndOfEnemyPhase = false; e.haloUntilEndOfEnemyPhase = false; e.emberUntilEndOfEnemyPhase = false; e.bombardverseUntilEndOfEnemyPhase = false; e.hasteUntilEndOfEnemyPhase = false; e.riposteUntilEndOfEnemyPhase = false; e.keenUntilEndOfEnemyPhase = false;
          n++;
        }
      }
      cleanseLog = `Cleanse Verse — ${n} all${n === 1 ? 'y' : 'ies'} purged of debuffs`;
    }
    let mireLog: string | null = null;
    if (sp === 'mireverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      mireLog = `Mire Verse — ${n} hostile${n === 1 ? '' : 's'} slowed + suppressed`;
    }
    let choirLog: string | null = null;
    if (sp === 'choirverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.sp = Math.min(e.def.pilot.maxSp, e.sp + 10);
          n++;
        }
      }
      choirLog = `Choir Verse — ${n} all${n === 1 ? 'y' : 'ies'} inspired +10 SP`;
    }
    let juggernautLog: string | null = null;
    if (sp === 'juggernautverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.juggernautUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      juggernautLog = `Juggernaut Verse — ${n} all${n === 1 ? 'y' : 'ies'} melee-boosted`;
    }
    let voidLog: string | null = null;
    if (sp === 'voidverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.focusUntilEndOfEnemyPhase = false; e.gritUntilEndOfEnemyPhase = false; e.guardUntilEndOfEnemyPhase = false; e.vanishUntilEndOfEnemyPhase = false; e.hymnUntilEndOfEnemyPhase = false; e.veilUntilEndOfEnemyPhase = false; e.counterBuffUntilEndOfEnemyPhase = false; e.counterSealUntilEndOfEnemyPhase = false; e.guardAuraUntilEndOfEnemyPhase = false; e.suppressDmgUntilEndOfEnemyPhase = false; e.absolveUntilEndOfEnemyPhase = false; e.bannerUntilEndOfEnemyPhase = false; e.statusproofUntilEndOfEnemyPhase = false; e.aegisUntilEndOfEnemyPhase = false; e.standFirmUntilEndOfEnemyPhase = false; e.firelinkUntilEndOfEnemyPhase = false; e.sanctumUntilEndOfEnemyPhase = false; e.oathUntilEndOfEnemyPhase = false; e.dirgeHealUntilEndOfEnemyPhase = false; e.chorusUntilEndOfEnemyPhase = false; e.anchoredUntilEndOfEnemyPhase = false; e.pinverseUntilEndOfEnemyPhase = false; e.tracerAllyUntilEndOfEnemyPhase = false; e.tideUntilEndOfEnemyPhase = false; e.mirrorwallUntilEndOfEnemyPhase = false; e.rampartUntilEndOfEnemyPhase = false; e.breachAtkUntilEndOfEnemyPhase = false; e.valiantUntilEndOfEnemyPhase = false; e.marksmanUntilEndOfEnemyPhase = false; e.warsongUntilEndOfEnemyPhase = false; e.relentlessUntilEndOfEnemyPhase = false; e.phantomUntilEndOfEnemyPhase = false; e.crimsonUntilEndOfEnemyPhase = false; e.scopeUntilEndOfEnemyPhase = false; e.goreUntilEndOfEnemyPhase = false; e.mirageUntilEndOfEnemyPhase = false; e.triumphUntilEndOfEnemyPhase = false; e.fortressUntilEndOfEnemyPhase = false; e.vigilUntilEndOfEnemyPhase = false; e.sentinelUntilEndOfEnemyPhase = false; e.siphonUntilEndOfEnemyPhase = false; e.salvoUntilEndOfEnemyPhase = false; e.shelterUntilEndOfEnemyPhase = false; e.juggernautUntilEndOfEnemyPhase = false; e.graceTurns = 0; e.renewalTurns = 0; e.foresightTurns = 0; e.clarionTurns = 0; e.bastionTurns = 0; e.mendTurns = 0; e.repulseUntilEndOfEnemyPhase = false; e.silencedUntilEndOfEnemyPhase = false; e.palisadeUntilEndOfEnemyPhase = false; e.weakenUntilEndOfEnemyPhase = false; e.obscuredTurns = 0; e.requiemUntilEndOfEnemyPhase = false; e.steadfastUntilEndOfEnemyPhase = false; e.nullifiedUntilEndOfEnemyPhase = false; e.tetherUntilEndOfEnemyPhase = false; e.seraphUntilEndOfEnemyPhase = false; e.wallUntilEndOfEnemyPhase = false; e.rustTurns = 0; e.stifleTurns = 0; e.rotTurns = 0; e.frailTurns = 0; e.gloomTurns = 0; e.poxTurns = 0; e.surgeUntilEndOfEnemyPhase = false; e.damperUntilEndOfEnemyPhase = false; e.tangleUntilEndOfEnemyPhase = false; e.leechUntilEndOfEnemyPhase = false; e.thornUntilEndOfEnemyPhase = false; e.surtaxUntilEndOfEnemyPhase = false; e.huskUntilEndOfEnemyPhase = false; e.vaultUntilEndOfEnemyPhase = false; e.freeflowUntilEndOfEnemyPhase = false; e.feebleUntilEndOfEnemyPhase = false; e.festerUntilEndOfEnemyPhase = false; e.slayUntilEndOfEnemyPhase = false; e.flakUntilEndOfEnemyPhase = false; e.chokeUntilEndOfEnemyPhase = false; e.fableUntilEndOfEnemyPhase = false; e.sustainUntilEndOfEnemyPhase = false; e.rootedUntilEndOfEnemyPhase = false; e.revelUntilEndOfEnemyPhase = false; e.sieveUntilEndOfEnemyPhase = false; e.bulwarkUntilEndOfEnemyPhase = false; e.beamverseUntilEndOfEnemyPhase = false; e.glitchUntilEndOfEnemyPhase = false; e.warlordUntilEndOfEnemyPhase = false; e.shellUntilEndOfEnemyPhase = false; e.mapSealUntilEndOfEnemyPhase = false; e.resistSealUntilEndOfEnemyPhase = false; e.gunUntilEndOfEnemyPhase = false; e.funnelUntilEndOfEnemyPhase = false; e.baneUntilEndOfEnemyPhase = false; e.haloUntilEndOfEnemyPhase = false; e.emberUntilEndOfEnemyPhase = false; e.bombardverseUntilEndOfEnemyPhase = false; e.hasteUntilEndOfEnemyPhase = false; e.riposteUntilEndOfEnemyPhase = false; e.keenUntilEndOfEnemyPhase = false; e.scorchUntilEndOfEnemyPhase = false; e.undyingUntilEndOfEnemyPhase = false; e.lanceUntilEndOfEnemyPhase = false; e.terraUntilEndOfEnemyPhase = false; e.markbrandUntilEndOfEnemyPhase = false; e.breakbrandUntilEndOfEnemyPhase = false; e.slowbrandUntilEndOfEnemyPhase = false; e.suppbrandUntilEndOfEnemyPhase = false; e.stunbrandUntilEndOfEnemyPhase = false; e.piercebrandUntilEndOfEnemyPhase = false; e.banebrandUntilEndOfEnemyPhase = false;
          n++;
        }
      }
      voidLog = `Void Verse — ${n} enem${n === 1 ? 'y' : 'ies'} dispelled`;
    }
    let ruinLog: string | null = null;
    if (sp === 'ruinverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      ruinLog = `Ruin Verse — ${n} enem${n === 1 ? 'y' : 'ies'} cracked & decaying`;
    }
    let anthemLog: string | null = null;
    if (sp === 'anthemverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3 && e.hp < e.def.maxHp) {
          e.hp = Math.min(e.def.maxHp, e.hp + Math.round(e.def.maxHp * 0.15));
          n++;
        }
      }
    ...
    let havocLog: string | null = null;
    if (sp === 'havocverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.havocUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      havocLog = `Havoc Verse — ${n} all${n === 1 ? 'y' : 'ies'} enraged`;
    }
    let swiftLog: string | null = null;
    if (sp === 'swiftverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.swiftUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      swiftLog = `Swift Verse — ${n} all${n === 1 ? 'y' : 'ies'} hastened`;
    }
    let shroudLog: string | null = null;
    if (sp === 'shroudverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.shroudUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      shroudLog = `Shroud Verse — ${n} foe${n === 1 ? '' : 's'} veiled`;
    }
    let wardvLog: string | null = null;
    if (sp === 'wardverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      wardvLog = `Ward Verse — ${n} all${n === 1 ? 'y' : 'ies'} shielded`;
    }
    let mendLog: string | null = null;
    if (sp === 'mendverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      mendLog = `Mend Verse — ${n} all${n === 1 ? 'y' : 'ies'} mending`;
    }
    let repulseLog: string | null = null;
    if (sp === 'repulseverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.repulseUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      repulseLog = `Repulse Verse — ${n} all${n === 1 ? 'y' : 'ies'} repulsed`;
    }
    let silenceLog: string | null = null;
    if (sp === 'silenceverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      silenceLog = `Silence Verse — ${n} enem${n === 1 ? 'y' : 'ies'} silenced`;
    }
    let magnumLog: string | null = null;
    if (sp === 'magnumverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          for (const w of e.def.weapons) if (w.ammo != null) e.ammo[w.id] = Math.min(maxAmmoOf(e, w), (e.ammo[w.id] ?? 0) + 1);
          n++;
        }
      }
      magnumLog = `Magnum Verse — ${n} all${n === 1 ? 'y' : 'ies'} resupplied`;
    }
    let palisadeLog: string | null = null;
    if (sp === 'palisadeverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.palisadeUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      palisadeLog = `Palisade Verse — ${n} all${n === 1 ? 'y' : 'ies'} palisaded`;
    }
    let fearLog: string | null = null;
    if (sp === 'fearverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      fearLog = `Fear Verse — ${n} enem${n === 1 ? 'y' : 'ies'} shaken`;
    }
    let veilbreakLog: string | null = null;
    if (sp === 'veilbreakverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
      ...
      veilbreakLog = `Veilbreak Verse — ${n} enem${n === 1 ? 'y' : 'ies'} revealed`;
    }
    let requiemLog: string | null = null;
    if (sp === 'requiemverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.requiemUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      requiemLog = `Requiem Verse — ${n} all${n === 1 ? 'y' : 'ies'} mourned`;
    }
    let steadfastLog: string | null = null;
    if (sp === 'steadfastverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.steadfastUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      steadfastLog = `Steadfast Verse — ${n} all${n === 1 ? 'y' : 'ies'} braced`;
    }
    let nullLog: string | null = null;
    if (sp === 'nullverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.nullifiedUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      nullLog = `Null Verse — ${n} enem${n === 1 ? 'y' : 'ies'} nullified`;
    }
    let tetherLog: string | null = null;
    if (sp === 'tetherverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
      ...
      tetherLog = `Tether Verse — ${n} enem${n === 1 ? 'y' : 'ies'} choked`;
    }
    let seraphLog: string | null = null;
    if (sp === 'seraphverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.seraphUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      seraphLog = `Seraph Verse — ${n} all${n === 1 ? 'y' : 'ies'} extended`;
    }
    let wallLog: string | null = null;
    if (sp === 'wallverse') {
      const src = units.find((x) => x.uid === uid)!;
      let n = 0;
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          e.wallUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      wallLog = `Wall Verse — ${n} all${n === 1 ? 'y' : 'ies'} shielded`;
    }
    ...
    if (sp === 'suppress') {
      ...
      for (const e of units) {
        if (e.alive && e.side !== src.side && dist(e.pos, src.pos) <= 3) {
          e.suppressDmgUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      suppressLog = `Suppress Fire — ${n} hostile${n === 1 ? '' : 's'} cowed: -10% damage dealt`;
    }
    ...
    // marksman — squad fire control: every living ally gains +15 crit until end of enemy phase
    let marksmanLog: string | null = null;
    if (sp === 'marksman') {
      let n = 0;
      for (const u2 of units) {
        if (u2.alive && u2.side === 'player') {
          u2.marksmanUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      marksmanLog = `\u25CE DEADEYE CALL — fire control paints ${n} frames: +15 crit`;
    }
    ...
    // empower — war blessing: the hardest hitter nearby gains +40% damage on their next attack
    let empowerLog: string | null = null;
    if (sp === 'empower') {
      const c = units.find((x) => x.uid === uid)!;
      const cand = units.filter((u2) => u2.alive && u2.side === 'player' && u2.uid !== uid && dist(u2.pos, c.pos) <= 3).sort((x, y) => (y.def.pilot.melee + y.def.pilot.ranged) - (x.def.pilot.melee + x.def.pilot.ranged))[0];
      if (cand) {
        cand.empowerForNextAttack = true;
        empowerLog = `\u2694 EMPOWER — ${cand.def.name} bristles with warlight`;
      }
    }
    // ward — aegis prayer: the weakest ally within 3 tiles survives their next fatal hit
    let wardLog: string | null = null;
    if (sp === 'ward') {
      const c = units.find((x) => x.uid === uid)!;
      const cand = units.filter((u2) => u2.alive && u2.side === 'player' && u2.uid !== uid && dist(u2.pos, c.pos) <= 3).sort((x, y) => x.hp / x.def.maxHp - y.hp / y.def.maxHp)[0];
      if (cand) {
        cand.wardenArmed = true;
        wardLog = `\u26E8 WARD — ${cand.def.name} is aegis-bound`;
      }
    }
    // warsong — anthem of the Ark: every living ally gains +10% damage until end of enemy phase
    let warsongLog: string | null = null;
    if (sp === 'warsong') {
      let n = 0;
      for (const u2 of units) {
        if (u2.alive && u2.side === 'player') {
          u2.warsongUntilEndOfEnemyPhase = true;
          n++;
        }
      }
      warsongLog = `\u266A WARSONG — the anthem swells: +10% damage across ${n} frames`;
    }
    // relay — patch the most-drained ally within 3 tiles with +30 EN
    let relayLog: string | null = null;
    if (sp === 'relay') {
      const cand = units
        .filter((u2) => u2.alive && u2.side === target.side && u2.uid !== uid && dist(u2.pos, target.pos) <= 3 && u2.en < u2.def.maxEn)
        .sort((x, y) => x.en - y.en)[0];
      if (cand) {
        cand.en = Math.min(cand.def.maxEn, cand.en + 30);
        relayLog = `\u26A1 RELAY — ${cand.def.name} draws reactor charge`;
      }
    }
    ...
    set({
      ...
      spiritForUid: null,
      usedSupport: true,
      log: trustLog || purgeLog || cheerLog || wishLog || gravityLog || decoyLog || hymnLog || empLog || phalanxLog || sanctLog || awakenLog || charityLog || siphonLog || empowerLog || marksmanLog || wardLog || warsongLog || relayLog || inspireLog || veilLog || cantataLog || warhornLog || interfereLog || safeguardLog || suppressLog || dischordLog || absolveLog || bannerLog || armorrotLog || winterverseLog || litanyLog || lockcascadeLog || wardmistLog || aegisLog || firelinkLog || dreadverseLog || sanctumLog || staticchoirLog || dirgemistLog || chorusLog || ariaLog || pinverseLog || tideverseLog || graceLog || mirrorwallLog || breachLog || ebbLog || renewalLog || valiantLog || exposeLog || darkLog || foresightLog || bastionLog || tracerLog || sirenLog || clarionLog || rampartLog || curseLog || vigorLog || phantomLog || crimsonLog || scopeLog || doomLog || flowLog || oathLog || goreLog || mirageLog || hexLog || triumphLog || fortressLog || bindLog || blightLog || vigilLog || sentinelLog || leechLog || terrorLog || salvoLog || shelterLog || cleanseLog || mireLog || choirLog || juggernautLog || voidLog || ruinLog || anthemLog || defianceLog || havocLog || swiftLog || shroudLog || wardvLog || mendLog || repulseLog || silenceLog || magnumLog || palisadeLog || fearLog || veilbreakLog || requiemLog || steadfastLog || nullLog || tetherLog || seraphLog || wallLog || rustLog || stifleLog || scorchLog || undyingLog || jamLog || despairLog || lanceLog || wardenLog || rotLog || frailLog || surgeLog || damperLog || gloomLog || tangleLog || leechvLog || thornLog || surtaxLog || huskLog || vaultLog || freeflowLog || feebleLog || festerLog || slayLog || flakLog || chokeLog || lureLog || fableLog || sustainLog || rootLog || maimLog || revelLog || bulwarkLog || poxLog || shatterLog || anchorLog || beamLog || riftLog || glitchLog || warlordLog || shellLog || gunLog || funnelLog || sealLog || zeroLog || baneLog || duskLog || reactorLog || haloLog || viceLog || drainLog || emberLog || bombardLog || cowardLog || nadirLog || hasteLog || riposteLog || brandLog || suppressvLog || keenLog || arsenalLog || muteLog || hazeLog || huntLog || rendLog || oblLog || jinxLog || rimeLog || staticLog || siegeLog || vexLog || pealLog || pierceLog || wraithLog || abyssLog || blitzLog || carnageLog || snareLog || quietusLog || bountyLog || graveLog ? push(push(s.log, `${u.def.name} uses ${SPIRITS[sp].name}`), [trustLog, purgeLog, cheerLog, wishLog, gravityLog, decoyLog, hymnLog, empLog, phalanxLog, sanctLog, awakenLog, charityLog, siphonLog, empowerLog, marksmanLog, wardLog, warsongLog, relayLog, inspireLog, veilLog, cantataLog, warhornLog, interfereLog, safeguardLog, suppressLog, dischordLog, absolveLog, bannerLog, armorrotLog, winterverseLog, litanyLog, lockcascadeLog, wardmistLog, aegisLog, firelinkLog, dreadverseLog, sanctumLog, staticchoirLog, dirgemistLog, chorusLog, ariaLog, pinverseLog, tideverseLog, graceLog, mirrorwallLog, breachLog, ebbLog, renewalLog, valiantLog, exposeLog, darkLog, foresightLog, bastionLog, tracerLog, sirenLog, clarionLog, rampartLog, curseLog, vigorLog, phantomLog, crimsonLog, scopeLog, doomLog, flowLog, oathLog, goreLog, mirageLog, hexLog, triumphLog, fortressLog, bindLog, blightLog, vigilLog, sentinelLog, leechLog, terrorLog, salvoLog, shelterLog, cleanseLog, mireLog, choirLog, juggernautLog, voidLog, ruinLog, anthemLog, defianceLog, havocLog, swiftLog, shroudLog, wardvLog, mendLog, repulseLog, silenceLog, magnumLog, palisadeLog, fearLog, veilbreakLog, requiemLog, steadfastLog, nullLog, tetherLog, seraphLog, wallLog, rustLog, stifleLog, scorchLog, undyingLog, jamLog, despairLog, lanceLog, wardenLog, rotLog, frailLog, surgeLog, damperLog, gloomLog, tangleLog, leechvLog, thornLog, surtaxLog, huskLog, vaultLog, freeflowLog, feebleLog, festerLog, slayLog, flakLog, chokeLog, lureLog, fableLog, sustainLog, rootLog, maimLog, revelLog, bulwarkLog, poxLog, shatterLog, anchorLog, beamLog, riftLog, glitchLog, warlordLog, shellLog, gunLog, funnelLog, sealLog, zeroLog, baneLog, duskLog, reactorLog, haloLog, viceLog, drainLog, emberLog, bombardLog, cowardLog, nadirLog, hasteLog, riposteLog, brandLog, suppressvLog, keenLog, arsenalLog, muteLog, hazeLog, huntLog, rendLog, oblLog, jinxLog, rimeLog, staticLog, siegeLog, vexLog, pealLog, pierceLog, wraithLog, abyssLog, blitzLog, carnageLog, snareLog, quietusLog, bountyLog, graveLog].filter(Boolean).join(' · ')) : push(s.log, `${u.def.name} uses ${SPIRITS[sp].name}`),
  ...
  endTurn: () => {
    ...
    const units = s.units.map((u) => {
      ...
      const c = { ...u, dodges: 0 };
      const r = phaseRecovery(c, s.map, s.units);
...
export function fogLit(units: UnitState[], p: Pos): boolean {
  return units.some((u) => u.alive && u.side === 'player' && dist(u.pos, p) <= FOG_RANGE + (partBonus(u, 'eagleEye') > 0 ? 2 : 0));
}
...
function detonateMineAt(set: SetFn, get: Get, uid: string, p: Pos, delayMs: number) {
  const go = () => {
    ...
    if (u.parts?.includes('defuseKit')) return;
...
function applyVictory(set: SetFn, get: Get) {
  ...
  if (side) {
    ...
    set({
      ...
      sideId: null,
      lastReward: reward,
      lastSalvage: s.salvageCr + stragglerCr, lastLoot: s.missionLoot,
      lastRank: rankS,
      missionRank,
      partsOwned,
      snowFox,
  ...
  while (guard++ < 20) {
    ...
    // field medic — mends the most wounded ally within 3 tiles, then ends its turn
    {
      ...
      if (med?.alive && med.def.medic && !med.acted) {
        const tgt = cur.units
          .filter((u) => u.alive && u.side === 'enemy' && u.uid !== med.uid && u.hp < u.def.maxHp && !u.festerUntilEndOfEnemyPhase && dist(u.pos, med.pos) <= 3)
          .sort((a, b) => a.hp / a.def.maxHp - b.hp / b.def.maxHp)[0];
        if (tgt) {
    ...
    const units = st.units.map((u) => {
      ...
      if (c.alive && c.statuses && c.statuses.length) {
        ...
        for (const fx of c.statuses) {
          if (fx.id === 'burn') {
            const dmg = Math.min(c.hp - 1, Math.round(c.def.maxHp * 0.08 * (partBonus(c, 'blazePlate') > 0 ? 0 : 1)));
            if (dmg > 0) {
              c.hp -= dmg;
      ...
      if (c.alive) {
        const r = phaseRecovery(c, st.map, st.units);
    ...
    if (!notice && end !== 'defeat') {
      notice =
        st.missionCh.turnLimit != null && nextTurn === st.missionCh.turnLimit
          ...
          : `PLAYER PHASE — TURN ${nextTurn} · ⏱ PAR ≤${st.missionCh.surviveTurns ?? (st.sideId ? Math.max(6, Math.ceil((st.missionCh.count ?? st.map.enemySpawns.length) * 1.2)) : Math.max(6, Math.ceil(((st.missionCh.count ?? st.map.enemySpawns.length) + (st.missionCh.boss ? 1 : 0)) * 1.1)))}`;
      setTimeout(() => set({ notice: null }), 2400);
    }
