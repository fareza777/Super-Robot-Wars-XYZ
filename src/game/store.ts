...
export const useGame = create<Store>((set, get) => ({
  ...
  mineDropUid: null,
    ...
    let carnageN = 0;
    {
      ...
      if (attClone) { attClone.lacerateNext = false; attClone.hellfireNext = false; attClone.thrillNext = false; attClone.sunderstormNext = false; attClone.ravenousNext = false; attClone.quakeedgeNext = false; }
