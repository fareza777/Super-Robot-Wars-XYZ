    ...
    if (sp === 'cleanseverse') {
      ...
      for (const e of units) {
        if (e.alive && e.side === src.side && dist(e.pos, src.pos) <= 3) {
          ...
          e.sirenTurns = 0;
          e.rustTurns = 0;
          e.stifleTurns = 0; e.rotTurns = 0; e.frailTurns = 0; e.surgeUntilEndOfEnemyPhase = false;
          n++;
        }
      }
