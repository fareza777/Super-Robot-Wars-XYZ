...
export const BOND_EVENTS: BondEvent[] = [
  ...
  },
  {
    ...
    bg: 'stars',
    lines: [
      { speaker: 'zephyra', text: 'Commander. I found you up here again — the observation deck really is your spot.' },
      { speaker: 'valstray', text: 'Orin. Could not sleep either? The void is quieter than the hangar tonight.' },
      { speaker: 'zephyra', text: 'I was reviewing your flight data. Your turns are insane — but they work. You fly like you are already gone.' },
      { speaker: 'valstray', text: 'And you fly like the wind owes you money. It is reckless, and I love watching it.' },
      { speaker: 'zephyra', text: '...That is the first time you said something nice without an order attached, Ray.' },
      { speaker: 'valstray', text: 'Then get used to it. Squadron XYZ has a heart, and you are part of it, Zephyra.' },
      { speaker: 'zephyra', text: '...Okay. Okay! But do not tell Mira I said this — she would aim that railgun at my wing.' },
    ],
  },
  {
    id: 'b17',
    title: "Falcon's Perch",
    chapter: 22,
    a: 'valstray',
    b: 'vexiaX',
    romance: true,
    bg: 'stars',
    lines: [
      { speaker: 'vexiaX', text: 'Commander Ray Ardent. The Falcon requests an audience — off the record.' },
      { speaker: 'valstray', text: 'Granted. You have been flying top cover for three sorties straight. Talk.' },
      { speaker: 'vexiaX', text: 'I defected for my squad, not for a flag. But you... you make a deserter want to stand somewhere.' },
      { speaker: 'valstray', text: 'The Ark takes anyone who turns their blade away from civilians. You already know that.' },
      { speaker: 'vexiaX', text: 'And if I say I turn it for you? Not the Ark — you. Falcon wings follow the wind they trust.' },
      { speaker: 'valstray', text: '...Vee. That is a dangerous thing to say to a commander.' },
      { speaker: 'vexiaX', text: 'I am a dangerous woman, Ray. Say the word and I will be your shadow — until the war ends. And after.' },
    ],
  },
  {
    id: 'b18',
    title: 'After the Last Shot',
    chapter: 28,
    a: 'valstray',
    b: 'arielis',
    romance: true,
    bg: 'stars',
    lines: [
      { speaker: 'arielis', text: 'Last battle tomorrow. I keep checking the ammo manifest like it will change if I stare long enough.' },
      { speaker: 'valstray', text: 'It will not. But we will. After this — no more scramble alarms at 0400.' },
      { speaker: 'arielis', text: 'You still owe me a proper question, Commander. The one you asked under the stars was on a battlefield.' },
      { speaker: 'valstray', text: 'I remember. When the guns go quiet — I want to wake up next to you in a world that does not need Valstray.' },
      { speaker: 'arielis', text: 'Then promise me one thing: no heroics tomorrow. Come home to me, Ray Ardent.' },
      { speaker: 'valstray', text: 'I promise. And after the last shot is fired — we will have forever to answer properly.' },
    ],
  },
  {
    id: 'b19',
    ...
    bg: 'stars',
    lines: [
      { speaker: 'vexiaX', text: 'You have been staring at that ring for an hour, Crimson. Whose finger is it for?' },
      { speaker: 'raxdenR', text: 'My mother kept it. It is the only thing she left me that is not a scar.' },
      { speaker: 'vexiaX', text: '...Rax. Are you asking what I think you are asking?' },
      { speaker: 'raxdenR', text: 'Not asking. Promising. When this war is done, Vee Corrin — you will wear it. If you want it.' },
      { speaker: 'vexiaX', text: '...I want it. Falcons do not nest just anywhere, you know. They nest where they are safe.' },
      { speaker: 'raxdenR', text: 'Then the Ark is your nest. And I am your wing, Vee — forever.' },
    ],
  },
];
