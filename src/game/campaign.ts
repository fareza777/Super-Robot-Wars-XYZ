...
export const PARTS: Record<string, PartDef> = {
  ...
  hornetRack: { id: 'hornetRack', name: 'Hornet Rack', desc: 'Sting array — funnel & gun weapons +12% damage', price: 3200, funnelDmg: 12, gunDmg: 12 },
  linkedCell: { id: 'linkedCell', name: 'Linked Cell', desc: 'Co-loader array — beam & ammo weapons +12% damage', price: 3200, beamDmg: 12, ammoDmg: 12 },
  voltaicRack: { id: 'voltaicRack', name: 'Voltaic Rack', desc: 'Charged array — missile & EN weapons +12% damage', price: 3200, missileDmg: 12, enDmg: 12 },
  ...
  fluxVeil: { id: 'fluxVeil', name: 'Flux Veil', desc: 'Phase-shift shroud — +8 mobility & barrier 400', price: 3200, mobility: 8, barrier: 400 },
  mendGauge: { id: 'mendGauge', name: 'Mend Gauge', desc: 'Regen-linked optics — +10 hit & +8% hull regen per turn', price: 3200, hit: 10, hpRegen: 8 },
  ...
  keepPlate: { id: 'keepPlate', name: 'Keep Plate', desc: 'Citadel laminate — +1200 max HP & 400 barrier', price: 3300, hp: 1200, barrier: 400 },
  marchGauge: { id: 'marchGauge', name: 'March Gauge', desc: 'Vector-loader optics — +8 mobility & regen 1 ammo per turn', price: 3300, mobility: 8, ammoRegen: true },
  surgeGauge: { id: 'surgeGauge', name: 'Surge Gauge', desc: 'Overfeed optics — +8% crit & +10 EN regen per turn', price: 3400, crit: 8, enRegen: 10 },
  ...
  tidePlate: { id: 'tidePlate', name: 'Tide Plate', desc: 'Neptune laminate — +1200 max HP & +8% hull regen per turn', price: 3400, hp: 1200, hpRegen: 8 },
  rookPlate: { id: 'rookPlate', name: 'Rook Plate', desc: 'Bulwark laminate — +1200 max HP & +8% crit', price: 3400, hp: 1200, crit: 8 },
  bishopPlate: { id: 'bishopPlate', name: 'Bishop Plate', desc: 'Cleric laminate — +1200 max HP & +3 SP regen per turn', price: 3400, hp: 1200, spRegen: 3 },
  flowPlate: { id: 'flowPlate', name: 'Flow Plate', desc: 'Riverine laminate — +8 mobility & +8% hull regen per turn', price: 3400, mobility: 8, hpRegen: 8 },
  ...
  strikerPlate: { id: 'strikerPlate', name: 'Striker Plate', desc: 'Vanguard laminate — +1200 max HP & +8 mobility', price: 3400, hp: 1200, mobility: 8 },
  ...
  packPlate: { id: 'packPlate', name: 'Pack Plate', desc: 'Quartermaster laminate — +8% hull regen & regen 1 ammo per turn', price: 3400, hpRegen: 8, ammoRegen: true },
  ...
  grovePlate: { id: 'grovePlate', name: 'Grove Plate', desc: 'Verdant laminate — +100 armor & regen 1 ammo per turn', price: 3400, armor: 100, ammoRegen: true },
  vigilPlate: { id: 'vigilPlate', name: 'Vigil Plate', desc: 'Sentinel laminate — +100 armor & +3 SP regen per turn', price: 3400, armor: 100, spRegen: 3 },
  gatePlate: { id: 'gatePlate', name: 'Gate Plate', desc: 'Portcullis laminate — +100 armor & immune to knockback/drag', price: 3400, armor: 100, knockProof: true },
  plumePlate: { id: 'plumePlate', name: 'Plume Plate', desc: 'Plasma-feather laminate — +8 evade & +10 EN regen/turn', price: 3400, evade: 8, enRegen: 10 },
  coilPlate: { id: 'coilPlate', name: 'Coil Plate', desc: 'Tesla-wound laminate — +10 hit & +10 EN regen/turn', price: 3400, hit: 10, enRegen: 10 },
  scopePlate: { id: 'scopePlate', name: 'Scope Plate', desc: 'Marksman laminate — +10 hit & +8 evade', price: 3400, hit: 10, evade: 8 },
  forgePlate: { id: 'forgePlate', name: 'Forge Plate', desc: 'Foundry laminate — +100 armor & +10 EN regen/turn', price: 3400, armor: 100, enRegen: 10 },
  wardLens: { id: 'wardLens', name: 'Ward Lens', desc: 'Aegis optics — +10 hit & barrier 400', price: 3400, hit: 10, barrier: 400 },
  castleGauge: { id: 'castleGauge', name: 'Castle Gauge', desc: 'Keep-mounted optics — +10 hit & +100 armor', price: 3400, hit: 10, armor: 100 },
  fencerPlate: { id: 'fencerPlate', name: 'Fencer Plate', desc: 'Duelist laminate — +8 evade & +8% crit', price: 3400, evade: 8, crit: 8 },
  duskPlate: { id: 'duskPlate', name: 'Dusk Plate', desc: 'Gloaming laminate — +8 evade & +5% hull regen/turn', price: 3400, evade: 8, hpRegen: 5 },
...
export const PILOT_STATS: PilotStatDef[] = [
  ...
  { id: 'winterborn', name: 'Winterborn', desc: '+6% damage per point vs slowed targets' },
  { id: 'trophyborn', name: 'Trophyborn', desc: '+6% damage per point vs elite targets' },
  { id: 'swiftborn', name: 'Swiftborn', desc: '+6% damage per point vs nimbler targets' },
  ...
  { id: 'missilefoe', name: 'Missilefoe', desc: '+6% damage per point vs missile-weapon carriers' },
  { id: 'meleefoe', name: 'Meleefoe', desc: '+6% damage per point vs melee-weapon carriers' },
  ...
  { id: 'baseborn', name: 'Baseborn', desc: '+5% damage per point vs targets standing on a base tile' },
  { id: 'roadborn', name: 'Roadborn', desc: '+5% damage per point vs targets standing on a road' },
  { id: 'sniperfoe', name: 'Sniperfoe', desc: '+6% damage per point vs frames carrying sniper weapons' },
  ...
  { id: 'chainfoe', name: 'Chainfoe', desc: '+6% damage per point vs frames carrying chain-arc weapons' },
  { id: 'breakerfoe', name: 'Breakerfoe', desc: '+6% damage per point vs frames carrying breaker weapons' },
  { id: 'volleyfoe', name: 'Volleyfoe', desc: '+6% damage per point vs frames carrying multi-strike weapons' },
  { id: 'acefoe', name: 'Acefoe', desc: '+6% damage per point vs frames carrying ace-locked weapons' },
  ...
  { id: 'cannonfoe', name: 'Cannonfoe', desc: '+6% damage per point vs frames carrying long-range artillery (7+ RNG)' },
  ...
  { id: 'dryborn', name: 'Dryborn', desc: '+6% damage per point vs frames with all limited weapons out of ammo' },
  ...
  { id: 'festerborn', name: 'Festerborn', desc: '+6% damage per point vs festered (un-healable) frames' },
  { id: 'trampleborn', name: 'Trampleborn', desc: '+6% damage per point vs frames slower than you' },
  { id: 'coreborn', name: 'Coreborn', desc: '+6% damage per point vs frames away from the map edge' },
  { id: 'rallyborn', name: 'Rallyborn', desc: '+4% damage per point per adjacent ally' },
  { id: 'cullborn', name: 'Cullborn', desc: '+6% damage per point vs frames at 30% hull or less' },
  { id: 'vengeborn', name: 'Vengeborn', desc: '+4% damage per point per fallen ally' },
  { id: 'lavaborn', name: 'Lavaborn', desc: '+5% damage per point vs targets standing on lava' },
  { id: 'medicfoe', name: 'Medicfoe', desc: '+6% damage per point vs medic frames' },
  { id: 'packborn', name: 'Packborn', desc: '+4% damage per point per enemy ally adjacent to the target' },
  { id: 'gauntletborn', name: 'Gauntletborn', desc: '+4% damage per point per enemy adjacent to you' },
  { id: 'tollborn', name: 'Tollborn', desc: '+6% damage per point vs carrier frames (loot haulers)' },
];
...
export const HONORS: HonorDef[] = [
  ...
  { id: 'h_godhunter4', name: 'GODHUNTER IV', desc: 'Destroy 50 bosses across your career', rewardCr: 100000 },
  { id: 'h_armory3', name: 'ARMORY LORD II', desc: 'Own 85 different parts', rewardCr: 100000 },
  { id: 'h_chainlord3', name: 'CHAINLORD III', desc: 'Score a 10-kill chain in a single turn', rewardCr: 100000 },
  ...
  { id: 'h_centurion5', name: 'CENTURION V', desc: 'Fly 100 ranked missions', rewardCr: 100000 },
  ...
  { id: 'h_tally3', name: 'TALLYMASTER III', desc: 'Earn 15,000+ salvage credits in a single mission', rewardCr: 100000 },
  { id: 'h_peacelord5', name: 'PEACELORD V', desc: 'Clear 120 side missions', rewardCr: 100000 },
  { id: 'h_omnicide4', name: 'OMNICIDE IV', desc: 'Destroy 35 different enemy frame types', rewardCr: 100000 },
  ...
  { id: 'h_pinnacle8', name: 'PINNACLE VIII', desc: 'Score rank S on 150 missions', rewardCr: 100000 },
  ...
  { id: 'h_chainlord8', name: 'CHAINLORD VIII', desc: 'Score a 20-kill chain in a single turn', rewardCr: 100000 },
  ...
  { id: 'h_stockpile8', name: 'STOCKPILE VIII', desc: 'Hold 250 items at once', rewardCr: 100000 },
  { id: 'h_armory9', name: 'ARMORY LORD IX', desc: 'Own 175 different parts', rewardCr: 100000 },
  { id: 'h_pinnacle10', name: 'PINNACLE X', desc: 'Score rank S on 170 missions', rewardCr: 100000 },
  { id: 'h_reaperlord', name: 'REAPER LORD', desc: 'One pilot reaches 2500 career kills', rewardCr: 100000 },
  { id: 'h_godblow', name: 'GODBLOW', desc: 'Land a single hit of 400000+ damage in battle', rewardCr: 100000 },
  { id: 'h_peacelord9', name: 'PEACELORD IX', desc: 'Clear 200 side missions', rewardCr: 100000 },
  { id: 'h_centurion11', name: 'CENTURION XI', desc: 'Fly 175 ranked missions', rewardCr: 100000 },
  { id: 'h_nemesis9', name: 'NEMESIS IX', desc: 'Destroy 500 frames of one type', rewardCr: 100000 },
  { id: 'h_omnicide5', name: 'OMNICIDE V', desc: 'Destroy 40 different frame types', rewardCr: 100000 },
  { id: 'h_godhunter17', name: 'GODHUNTER XVII', desc: 'Destroy 550 bosses over your career', rewardCr: 100000 },
  { id: 'h_centurion12', name: 'CENTURION XII', desc: 'Fly 200 ranked missions', rewardCr: 100000 },
  ...
  { id: 'h_nemesis2', name: 'NEMESIS II', desc: 'Destroy 150 frames of a single type', rewardCr: 100000 },
  ...
  { id: 'h_bondlord', name: 'BONDLORD', desc: 'Reach max bond (lv3) on 3 pairs', rewardCr: 100000 },
  { id: 'h_voidwalker', name: 'VOIDWALKER', desc: 'Win a mission on a void map', rewardCr: 100000 },
];
...
units?: { def: { id: string; maxHp?: number }; kills: number; alive: boolean; side: string; hp?: number; wounded?: boolean; npc?: boolean }[]; transformed?: boolean; usedSupport?: boolean; altKill?: boolean; decoyHit?: boolean; iFieldKill?: boolean; mirrorWon?: boolean; arcKill?: boolean; blastKill?: boolean; lostAlly?: boolean; snipeKill?: boolean; rescuedPods?: string[]; bossRush?: boolean; chainCount?: number }): boolean {
  ...
  switch (h.id) {
    ...
    case 'h_godhunter4':
      return (s.killsByDef ? Object.entries(s.killsByDef).filter(([id]) => ALL_UNITS[id]?.boss).reduce((n, [, k]) => n + k, 0) : 0) >= 50;
    case 'h_armory3':
      return (s.partsOwned ?? []).length >= 85;
    case 'h_soulbound':
    ...
    case 'h_centurion5':
      return Object.keys(s.missionRank ?? {}).length >= 100;
    case 'h_centurion6':
      return Object.keys(s.missionRank ?? {}).length >= 110;
    case 'h_centurion7':
      return Object.keys(s.missionRank ?? {}).length >= 120;
    case 'h_centurion8':
      return Object.keys(s.missionRank ?? {}).length >= 130;
    case 'h_centurion9':
      return Object.keys(s.missionRank ?? {}).length >= 140;
    case 'h_centurion10':
      return Object.keys(s.missionRank ?? {}).length >= 150;
    case 'h_centurion11':
      return Object.keys(s.missionRank ?? {}).length >= 175;
    case 'h_centurion12':
      return Object.keys(s.missionRank ?? {}).length >= 200;
    case 'h_pinnacle2':
    ...
    case 'h_stockpile7':
      return Object.values(s.inventory ?? {}).reduce((n, c) => n + c, 0) >= 225;
    case 'h_stockpile8':
      return Object.values(s.inventory ?? {}).reduce((n, c) => n + c, 0) >= 250;
    case 'h_armory4':
      return (s.partsOwned ?? []).length >= 95;
    case 'h_armory5':
      return (s.partsOwned ?? []).length >= 110;
    case 'h_armory6':
      return (s.partsOwned ?? []).length >= 125;
    case 'h_armory7':
      return (s.partsOwned ?? []).length >= 140;
    case 'h_armory8':
      return (s.partsOwned ?? []).length >= 160;
    case 'h_armory9':
      return (s.partsOwned ?? []).length >= 175;
    case 'h_armory8':
      return (s.partsOwned ?? []).length >= 160;
    case 'h_armory9':
      return (s.partsOwned ?? []).length >= 175;
    ...
    case 'h_dreamteam7':
      return kills.length > 0 && kills.every((p) => (p.kills ?? 0) >= 1250);
    case 'h_pinnacle3':
    ...
    case 'h_pinnacle7':
      return Object.values(s.missionRank ?? {}).filter((r) => r === 'S').length >= 140;
    case 'h_pinnacle8':
      return Object.values(s.missionRank ?? {}).filter((r) => r === 'S').length >= 150;
    case 'h_pinnacle9':
      return Object.values(s.missionRank ?? {}).filter((r) => r === 'S').length >= 160;
    case 'h_pinnacle10':
      return Object.values(s.missionRank ?? {}).filter((r) => r === 'S').length >= 170;
    case 'h_reaperlord':
      return kills.some((p) => (p.kills ?? 0) >= 2500);
    case 'h_godblow':
      return (s.maxHitEver ?? 0) >= 400000;
    case 'h_peacelord4':
      return (s.sideCleared ?? []).length >= 100;
    case 'h_peacelord5':
      return (s.sideCleared ?? []).length >= 120;
    case 'h_peacelord6':
    ...
    case 'h_peacelord9':
      return (s.sideCleared ?? []).length >= 200;
    case 'h_apexlegion3':
      return kills.length > 0 && kills.every((p) => (p.kills ?? 0) >= 750);
    case 'h_apexlegion4':
      return kills.length > 0 && kills.every((p) => (p.kills ?? 0) >= 1000);
    case 'h_apexlegion5':
      return kills.length > 0 && kills.every((p) => (p.kills ?? 0) >= 1500);
    case 'h_godhunter8':
    ...
    case 'h_godhunter17':
      return (s.killsByDef ? Object.entries(s.killsByDef).filter(([id]) => ALL_UNITS[id]?.boss).reduce((n, [, k]) => n + k, 0) : 0) >= 550;
    case 'h_extinction':
    ...
    case 'h_omnicide3':
      return Object.keys(s.killsByDef ?? {}).length >= 30;
    case 'h_omnicide4':
      return Object.keys(s.killsByDef ?? {}).length >= 35;
    case 'h_omnicide5':
      return Object.keys(s.killsByDef ?? {}).length >= 40;
    case 'h_nemesis2':
      return Math.max(0, ...Object.values(s.killsByDef ?? {})) >= 150;
    case 'h_nemesis3':
      return Math.max(0, ...Object.values(s.killsByDef ?? {})) >= 200;
    case 'h_nemesis4':
      return Math.max(0, ...Object.values(s.killsByDef ?? {})) >= 250;
    case 'h_nemesis5':
    ...
    case 'h_nemesis9':
      return Math.max(0, ...Object.values(s.killsByDef ?? {})) >= 500;
    case 'h_perfectscore': {
    ...
    case 'h_tally2':
      return (s.salvageCr ?? 0) >= 12000;
    case 'h_tally3':
      return (s.salvageCr ?? 0) >= 15000;
    case 'h_flashwar':
      return (s.turn ?? 99) <= 2;
    case 'h_godtouched':
      return s.ngPlus >= 25;
    ...
    case 'h_bondlord':
      return Object.values(s.bonds ?? {}).filter((l) => l >= 3).length >= 3;
    case 'h_voidwalker':
