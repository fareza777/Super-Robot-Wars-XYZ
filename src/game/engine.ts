...
export function enCostOf(u: UnitState, w: WeaponDef): number {
  ...
  return (mult < 1 ? Math.max(1, Math.round(w.enCost * mult)) : w.enCost) + (u.surtaxUntilEndOfEnemyPhase ? 10 : 0);
}
