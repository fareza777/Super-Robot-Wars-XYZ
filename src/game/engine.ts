...
export function applyAttack(state: GameState, attackerUid: string, defenderUid: string, weaponId: string, mods?: (u: UnitState) => CombatMods, reaction: Reaction = 'counter'): { state: GameState; result: AttackResult } {
  ...
  att.pyreNext = false; att.cinderNext = false; att.maraudNext = false; att.howlNext = false; att.vampNext = false; att.disarmNext = false; att.twinNext = false; att.pierceNext = false; att.reshiftNext = false; att.muteNext = false; att.dragNext = false; att.blinkNext = false; att.curseNext = false; att.shroudNext = false;
